...
class Ui_Settings_Dialog(object):
    ...
    def setupUi(self, Settings_Dialog):
        ...
        self.comboBox_inputDevice2 = QtWidgets.QComboBox(Settings_Dialog)
        self.comboBox_inputDevice2.setObjectName("comboBox_inputDevice2")
        self.verticalLayout_5.addWidget(self.comboBox_inputDevice2)
